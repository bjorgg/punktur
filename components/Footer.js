    ...
    return (
        <footer className={styles.footer}>
            <div>
                ...
                <Modal show={isAboutPunktOpen} title="Um Punkt" onClose={() => setAboutPunktModalOpen(false)} cancelText="Loka">
                    <div>
            ...
            <div className={styles.notandi}>
                ...
                <Modal show={isOpen} title="Notendaskilmálar" onClose={() => setModalOpen(false)} cancelText="Loka">
                    <div>
